...
if __name__ == "__main__":
    ...
    C, lmda = [float(sys.argv[j]) for j in [5, 6]]
    dataset = sys.argv[7]
    ...
    with open(f"../results/cs/{dataset}_n={n}_no_trees={no_trees}_"
              f"C={C:.3}_lambda={lmda:.6}_tryno={try_number}.json", 'w', encoding='utf-8') as f:
        results_dict = {"n": n, "no_trees": no_trees, "depth": depth, "C": C, "lambda": lmda, "try_number": try_number,
