...
class BoneMarrow:
    def __init__(self):
        script_dir = os.path.dirname(__file__)
        rel_path = "dataset_management/regression_datasets/bonemarrow/data.csv"
        abs_file_path = os.path.join(script_dir, rel_path)
        file = pd.read_csv(abs_file_path, sep=',')
...
class GPS:
    def __init__(self):
        script_dir = os.path.dirname(__file__)
        rel_path = "dataset_management/regression_datasets/UJIndoorLoc/trainingData.csv"
        abs_file_path = os.path.join(script_dir, rel_path)
        file = pd.read_csv(abs_file_path, sep=',')
...
class DaeguRealEstate:
    def __init__(self):
        script_dir = os.path.dirname(__file__)
        rel_path = "dataset_management/regression_datasets/Daeg_real_estate/Daegu_Real_Estate_data.csv"
        abs_file_path = os.path.join(script_dir, rel_path)
        file = pd.read_csv(abs_file_path, sep=',')
        # print(file.values[0,:])
        self.samples = 5891
...
class LasvegasHotelDataset:
    def __init__(self):
        script_dir = os.path.dirname(__file__)
        rel_path = "dataset_management/regression_datasets/LasVegasTripadvisor/LasVegasTripAdvisorReviews-Dataset.csv"
        abs_file_path = os.path.join(script_dir, rel_path)
        file = pd.read_csv(abs_file_path, sep=';')
        self.samples = 504
...
class GPUDataset:
    def __init__(self):
        script_dir = os.path.dirname(__file__)
        rel_path = "dataset_management/regression_datasets/SGEMM_GPU/sgemm_product.csv"
        abs_file_path = os.path.join(script_dir, rel_path)
        file = pd.read_csv(abs_file_path, sep=',')
        print(file.shape)
        self.samples = 241599
...
class WineDataset:
    def __init__(self):
        script_dir = os.path.dirname(__file__)
        rel_path = "dataset_management/regression_datasets/wine_quality/winequality-white.csv"
        abs_file_path = os.path.join(script_dir, rel_path)
        file = pd.read_csv(abs_file_path, sep=';')
        print(file.shape)
        self.samples = 4598
